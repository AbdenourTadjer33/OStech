...
const Alert = ({ type, className = "", content = "", ...props }) => {
	...
	const alertStyles = {
		success: `bg-green-50 text-green-800 ${baseStyles}`,
		danger: `bg-red-50 text-red-800 ${baseStyles}`,
		info: `bg-blue-50 text-blue-800 ${baseStyles}`,
		warning: `bg-yellow-50 text-yellow-800 ${baseStyles}`,
	};
